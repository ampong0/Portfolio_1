...
<label for="skill_id " class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Skills</label>
   ...
   <option value="{{ $skill->id}}">{{ $skill->name}}
    ...
    @endforeach
        ...
        <div>
            ...
            <x-text-input id="project_url" class="block mt-1 w-full" type="text" name="rpoject_url" :value="old('project_url')" />
